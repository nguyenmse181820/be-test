...
public class BookingUtils {
     ...
     * @param price Price for this passenger on this segment
     * @param bookingCode Booking reference code with optional segment suffix
     * @param flightIndex Flight index for ordering (positive for outbound, negative for return)
     * @return A new BookingDetail entity
     */
    public static BookingDetail createBookingDetail(
            Booking booking,
    ...
    /**
     * Creates a BookingDetail entity for a passenger on a flight segment
     * Overloaded version for backward compatibility (without flight index)
     * 
     * @param booking The booking entity
     * @param passenger The passenger entity
     * @param flightId The flight ID
    ...
    public static BookingDetail createBookingDetail(
        ...
        return createBookingDetail(booking, passenger, flightId, flightCode, originAirportCode, 
                destinationAirportCode, departureTime, arrivalTime, fareName, seatCode, price, 
                bookingCode, null);
    }
    ...
    public static BookingDetailsResult createBookingDetailsForSegmentWithActualPricing(
        ...
        return createBookingDetailsForSegmentWithActualPricing(booking, passengerEntities, passengerInfos, flightId, 
                flightCode, originAirportCode, destinationAirportCode, departureTime, arrivalTime, 
                selectedFareName, seatSelections, actualPricingMap, bookingCode, null);
    }
