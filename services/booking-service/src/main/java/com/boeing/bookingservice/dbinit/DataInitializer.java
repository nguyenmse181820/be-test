...
//
//    // Counter to ensure unique order codes
//    private static final AtomicLong orderCodeCounter = new AtomicLong(System.currentTimeMillis());
...
//                .orderCode(orderCodeCounter.incrementAndGet()) // Ensure unique order code
//                .amount(amount)
//                .currency("VND")
